...
using BookStore.Blazor.Server.Tiered.Components;
using BookStore.Blazor.Server.Tiered.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/BookStore.Blazor.Server.Tiered.styles.css", true));
                }
            );
        });
    }
