...
using BookStore.Blazor.WebApp.Tiered.Client;
using BookStore.Blazor.WebApp.Tiered.Client.Menus;
using BookStore.Blazor.WebApp.Tiered.Components;
using BookStore.Blazor.WebApp.Tiered.Menus;
...
namespace BookStore.Blazor.WebApp.Tiered;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/BookStore.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
