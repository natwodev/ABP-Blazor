...
{
    private IReadOnlyList<AuthorDto> AuthorList { get; set; } = Array.Empty<AuthorDto>();
    ...
    private Modal CreateAuthorModal { get; set; } = null!;
    private Modal EditAuthorModal { get; set; } = null!;

    private Validations CreateValidationsRef = null!;
    
    private Validations EditValidationsRef = null!;
