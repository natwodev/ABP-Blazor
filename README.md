...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7ede9dc4-a957-424e-871f-54cb9e10fd3a
```

> `7ede9dc4-a957-424e-871f-54cb9e10fd3a` is the password of the certificate, you can change it to any password you want.
